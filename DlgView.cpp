...
BEGIN_MESSAGE_MAP(DlgView, CFormView)
	//{{AFX_MSG_MAP(DlgView)
	//}}AFX_MSG_MAP
	ON_EN_KILLFOCUS(IDC_EDIT1, &DlgView::OnEditChange)
	ON_EN_KILLFOCUS(IDC_EDIT2, &DlgView::OnEditChange)
	ON_EN_KILLFOCUS(IDC_EDIT3, &DlgView::OnEditChange)
	ON_EN_KILLFOCUS(IDC_EDIT4, &DlgView::OnEditChange)
END_MESSAGE_MAP()
...
void DlgView::DoDataExchange(CDataExchange* pDX)
{
	...
	//}}AFX_DATA_MAP
	DDX_Text(pDX, IDC_EDIT1, GetDocument()->coordinates.left);
	DDX_Text(pDX, IDC_EDIT2, GetDocument()->coordinates.top);
	DDX_Text(pDX, IDC_EDIT3, GetDocument()->coordinates.right);
	DDX_Text(pDX, IDC_EDIT4, GetDocument()->coordinates.bottom);
}
